							...
							<u-row class="body" customStyle="margin-bottom: 10px" justify="center" align="center"
								...
								<u-col span="12" textAlign="center" justify="center" align="center">
									<u-button style="border-radius: 5px;" color='#F2F2F2' class="font">
										<span style="color: #FF3F43;" v-for="(notLet,index) in item.notLetOddsList"
											v-if="notLet.active">
										...
										<span style="color: #FF3F43;" v-for="(goal,index) in item.goalOddsList"
											v-if="goal.active">
											{{goal.describe}}({{goal.odds}}),
										</span>

										<span style="color: #FF3F43;" v-for="(half,index) in item.halfWholeOddsList"
											v-if="half.active">
											{{half.describe}}({{half.odds}}),
										</span>

										<span style="color: #FF3F43;" v-for="(score,index) in item.scoreOddsList"
											v-if="score.active">
			...
			<div class="buyFooter_wrap">
				...
				<div class="buyFooter_count">
					<view
						...
						投<u-number-box :value="times" iconStyle="color: #FF3F43" integer inputWidth="70"
							@change="numberChange">
						</u-number-box>倍
					</view>
