		...
		<view style="padding:20px 5px;">
				...
				<view style="display: flex; align-items: center;">
					...
					<view style="display: flex; flex-direction: column; margin-left: 10px;">
						...
						<view style="display: flex; align-items: center; font-size: 11px;">
							<view
								style="color: #FF3F43; border: 1px solid red; border-radius: 7px 0px 0px 7px; height: 20px; line-height: 20px; text-align: center; padding: 0px 10px;">
								{{documentaryData.hit}}
							</view>
							<view
								style="height: 22px; line-height: 20px; padding: 0px 10px; background-color: #FF3F43; text-align: center; border-radius: 0px 7px 7px 0px; color: white;">
								盈利率{{documentaryData.profit}}%</view>
						</view>
					</view>
				</view>
				<view v-if="!documentaryData.isFollow" @tap="followBtn('0',documentaryData.id)"
					style="border: 1px solid #FF3F43; border-radius: 15px; height: 25px; line-height: 25px; padding: 0px 15px; text-align: center; color: #FF3F43;margin-right: 15px;">
					关注</view>
			...
			<view style="background-color: white; padding: 10px; border-radius: 10px; margin-top: 30px;">
				...
				<view>
					...
					<u-tabs lineHeight="2" :list="tabsList" lineColor="#FF3F43" :scrollable="false" lineWidth="60"
						:activeStyle="{color: '#FF3F43',transform: 'scale(1.05)'}" @click="tabsBtn">
					</u-tabs>
					<scroll-view>
						...
						<view v-if="frequencyFlag">
							...
							<view v-if="documentaryData.documentaryUserList.length>0"
								...
								<view>
									<text style="color: #FF3F43;font-weight: bold;">￥{{item.price}}</text>
								</view>
							</view>
						</view>
					</scroll-view>
		...
		<view v-if="documentaryData.endTime>0"
			...
			<view style="display: flex; align-items: center; justify-content: space-between;">
				<view style="display: flex; align-items: center; margin-left: 10px;">
					...
					<view style="margin-left: 10px;">合计<text style="color: #FF3F43;"><span>{{price}}</span></text>元
					</view>
				</view>
				<view style="margin-right: 10px;">
					<u-button @tap="confirmIsShow=true"
						style="background-color: #FF3F43; color: #ffffff;border-radius: 10px;padding: 0px 45px;margin-top: 10px;"
						text="立即跟单"></u-button>
				</view>
			</view>
		</view>
