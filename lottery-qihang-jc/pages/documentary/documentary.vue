<template>
	<view class="box">
		<cmd-nav-bar @iconOne="iconOneBtn" iconOne="search" title="跟单大厅" font-color="#fff" background-color="#FF3F43">
		</cmd-nav-bar>
		...
		<view class="content">
			<scroll-view>
				...
				<view style="background: #fff;height: 50px;">
					<u-tabs :list="tabsList" lineColor="#FF3F43" :scrollable="false" lineWidth="50"
						:activeStyle="{color: '#FF3F43',fontWeight: 'bold',transform: 'scale(1.05)'}" @click="tabsBtn">
					</u-tabs>
				</view>
				<scroll-view>
							...
							<view style="display: flex; align-items: center;"
								...
								<view
									...
									<view style="display: flex; flex-direction: column; align-items: center;">
										<view>
											自购</view>
										<view style="color: #FF3F43;">{{item.price}}</view>
									</view>
									<view style="border-right: 1px solid rgb(214, 214, 214); height: 26px; width: 1px;">
									</view>
									<view style="display: flex; flex-direction: column; align-items: center;">
										<view>
											人气</view>
										<view style="color: #FF3F43;">{{item.quantity}}</view>
									</view>
								</view>
								<view
