...
//            }
    ...
    public static List<LotteryTicketDO> getBeidanTicketVOBySechme(String schedetail, List<BeiDanMatchDTO> footballMatchDTOS, String orderNo, String mode) {
     ...
     * 串关 拆分票据
     */
    public static List<LotteryTicketDO> getBeidanTicketVO(List<BeiDanMatchDTO> footballMatchDTOS, List<Integer> playType, String orderNo, Integer times) {
    ...
    private static ArrayList<TicketVO> buildTicketVO(BeiDanMatchDTO dto) {
        ...
        if (!CollectionUtils.isEmpty(dto.getOddEvenOdds())) {
            ticketContentVOList = new ArrayList<>(100);
            ticketVO.setMode("3");
            for (Map<String, Object> list : dto.getOddEvenOdds()) {
                TicketContentVO ticketContentVO = JSON.parseObject(JSON.toJSONString(list), TicketContentVO.class);
