...
//                order.setSchemeDetails(JSON.toJSONString(listVOList));
            ...
            return BaseDataVO.builder().success(true).data("有对阵未获取赛果").build();
        }
        return BaseDataVO.builder().success(true).data("奖金[" + bonuseVO.getMoney().toPlainString() + "]").build();
    }
