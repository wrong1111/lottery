<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="voList" border stripe>
      ...
      <el-table-column label="操作" align="center" width="400">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="success" @click="recharegeUser(scope.row)"
            >充值</el-button
          >
          <el-button size="mini" type="danger" @click="updateUserPwdAction(scope.row)"
            >修改密码</el-button
          >
          <el-button
            size="mini"
    ...
    <verify-pwd-dialog
      :visible.sync="dialogVerifyPwdVisible"
      title="交易密码确认"
      @confirm="verifyPwd"
    ></verify-pwd-dialog>
